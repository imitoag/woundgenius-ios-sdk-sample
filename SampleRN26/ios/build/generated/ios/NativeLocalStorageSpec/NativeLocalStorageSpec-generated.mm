...
namespace facebook::react {
    ...
    static facebook::jsi::Value __hostFunction_NativeLocalStorageSpecJSI_startCapturing(facebook::jsi::Runtime& rt, TurboModule &turboModule, const facebook::jsi::Value* args, size_t count) {
      return static_cast<ObjCTurboModule&>(turboModule).invokeObjCMethod(rt, PromiseKind, "startCapturing", @selector(startCapturing:reject:), args, count);
    }
  ...
  NativeLocalStorageSpecJSI::NativeLocalStorageSpecJSI(const ObjCTurboModule::InitParams &params)
    : ObjCTurboModule(params) {
        ...
        methodMap_["startCapturing"] = MethodMetadata {0, __hostFunction_NativeLocalStorageSpecJSI_startCapturing};
